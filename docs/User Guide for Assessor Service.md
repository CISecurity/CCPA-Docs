...
##Benchmark Coverage##
CIS-CAT Pro Assessor v4 Service supports all CIS benchmarks included with CIS-CAT Pro Assessor v4, except for those that require interactive values. Interactive Benchmarks can be reviewed here: [https://ccpa-docs.readthedocs.io/en/latest/Coverage%20Guide/](https://ccpa-docs.readthedocs.io/en/latest/Coverage%20Guide/).
